...
- Only add a comment when the *why* isn't obvious from the code: a non-obvious constraint, an invariant, a workaround for a specific bug, or behavior that would otherwise surprise a reader.
